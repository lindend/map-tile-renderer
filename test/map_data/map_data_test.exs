defmodule MapTileRenderer.MapDataTeset do
    ...
    test "reads a closed way as an area" do
        ...
        assert [%MapTileRenderer.MapData.Area{id: 4, vertices: [{1.0, 0.0}, {3.0, 2.0}, {5.0, 4.0}, {1.0, 0.0}], tags: @test_tags}] = result
    end
    ...
    test "reads a multipolygon relation as multiarea" do
        ...
        assert [%MapTileRenderer.MapData.MultiArea{id: 6, tags: @test_tags, areas: [
            %MapTileRenderer.MapData.Area{id: 4, tags: %{}, type: :land, vertices: [{1.0, 0.0}, {3.0, 2.0}, {5.0, 4.0}, {1.0, 0.0}]},
            %MapTileRenderer.MapData.Area{id: 5, tags: %{}, type: :land, vertices: [{1.0, 0.0}, {3.0, 2.0}, {5.0, 4.0}, {1.0, 0.0}]}]}] = result
    end
